...
Most diagnostics use risduals

``` r
#takes the model coefficients
...
``` r
#only works if it's nested models (fit_null is nested inside fit_alt)
...
```
    ...
    ##   term                  estimate std.error statistic   p.value
    ##   <chr>                    <dbl>     <dbl>     <dbl>     <dbl>
    ## 1 (Intercept)               207.      6.77     30.6  6.59e-102
    ## 2 room_typePrivate room    -107.     10.0     -10.7  1.81e- 23
    ## 3 room_typeShared room     -152.     94.8      -1.61 1.09e-  1
...
```
    ...
    ##   term                  estimate std.error statistic   p.value
    ##   <chr>                    <dbl>     <dbl>     <dbl>     <dbl>
    ## 1 (Intercept)               266.      7.14     37.3  1.59e-195
    ## 2 room_typePrivate room    -116.     14.0      -8.33 2.41e- 16
    ## 3 room_typeShared room     -158.     41.2      -3.84 1.30e-  4
